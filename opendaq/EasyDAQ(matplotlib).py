    ...
    def run(self):  
        while self.running:
            ...
            if self.drawing:
                ...
                frame.p.axes.plot(comunicationThread.y[0],comunicationThread.x[0])
                frame.p.axes.plot(comunicationThread.y[1],comunicationThread.x[1])
                frame.p.axes.plot(comunicationThread.y[2],comunicationThread.x[2])
                frame.p.axes.plot(comunicationThread.y[3],comunicationThread.x[3])
                frame.p.canvas.draw()
